...
- Note however that the run_analysis file includes the needed functions to download the packages if need be, you can search for the term "install.packages" and remove the "#" in the "run_analysis.R" file with the install.packages() function for the above packages.
```
